...
osiris::yield_to_gcam_basin(
  ...
  iso_GCAM_regID = paste0(data_folder,"/mapping_data/iso_GCAM_regID.csv"),
  FAO_ag_items_PRODSTAT = paste0(data_folder,"/mapping_data/FAO_ag_items_PRODSTAT_expanded_corrected.csv"),
  L100.LDS_ag_HA_ha = paste0(data_folder,"/mapping_data/L100.LDS_ag_HA_ha.csv"),
  iso_GCAM_basinID = paste0(data_folder,"/mapping_data/gcam_basin_ids.csv"),
  max_CCImult = 2.5,
  min_CCImult = 0.01,
  weight_floor_ha = 1,
